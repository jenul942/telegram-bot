...
class BotHandler:
    def __init__(self, token):
            self.token = token
            self.api_url = "https://api.telegram.org/bot{1564763025:AAFmWQLsj-CRqx8gIrudDnU3JUyX01C5GVs}/".format(token)
...
token = '1564763025:AAFmWQLsj-CRqx8gIrudDnU3JUyX01C5GVs' #Token of your bot
